...
export function InterviewConsultingAction() {
  return <div className="consulting-cta-container">
    ...
    <a class="cta-interview" href="https://go.lambrospetrou.com/interview-prep" target="_blank" rel="noopener">
...
export default function Index() {
  return (
    <Layout className="hire-container" wrapInnerSection={false}>
      <Head>
        <link rel="canonical" href="https://www.lambrospetrou.com/consulting/" />
      ...
      {/* <p style={{textAlign: "center"}}>What I can do for you</p> */}

      <div className="inner-section stacked">
        <section id="websites">
          <h3>Websites & APIs</h3>
          <ul>
