      ...
      <div className="header-strip">
        <div id="inner-header" className="inner-section">
          ...
          <div id="nav-buttons">
            ...
            <a className="cta-skybear" href="https://www.skybear.net/" title="Skybear.net Scripts" rel="noopener" target="_blank">Skybear.net</a>
            {/* <a href="https://temp.minibri.com" title="Minibri Temp - Share content with expiration" rel="noopener" target="_blank">Minibri Temp</a> */}
            {/* <a className="cta-hire" href="/tech-interviews/" >1:1 Mock Interviews</a> */}
