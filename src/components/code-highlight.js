export const CodeHighlightScripts = ({}) => {
  ...
  return (
    <>
      ...
      <script src="/s/prismjs/prism-core.min.js"></script>
      <script src="/s/prismjs/prism-autoloader.min.js" data-autoloader-path="https://cdnjs.cloudflare.com/ajax/libs/prism/1.20.0/components/"></script>
    </>
  );
};
