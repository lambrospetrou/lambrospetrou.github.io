...
If the partitions look like a they form B+tree, it's because they kinda do.

As we will explore below, there are internal nodes acting as routers only forwarding requests, and then leaf nodes that actually have the data and process the queries. There are some nuanced details about it, but the premise holds in general.
